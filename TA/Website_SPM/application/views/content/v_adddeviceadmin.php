                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <!-- <div class="form-group">
                      ...
                      <input class="form-control bradius" type="text" name="displayValue" id="displayValue" placeholder="Owner's Name" onfocus="this.select()">
                      <select class="form-control bradius" onchange="document.getElementById('displayValue').value=this.options[this.selectedIndex].value;">
                      <select class="form-control select2" name="oname" style="height:100%">
                        <option value="">Select Available </option>
                        <option value="ones">one</option>
                        <option value="twos">two</option>
                        <option value="threes">three</option>
                      </select>
                    </div>
                    <div class="form-group">
                      <label>ID</label>
                      <input type="text" class="form-control bradius" name="pId" placeholder="Owner's ID" required="">
                    </div> -->
                    <div class="form-group">
