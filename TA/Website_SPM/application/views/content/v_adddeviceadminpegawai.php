      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" method="POST" action="<?php echo base_url('device/add_employee') ?>">
                <div class="row">
                  <div class="col-md-4"></div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>Employee Name</label>
                      <select class="form-control select2" name="employeeid" style="height: 100%;" required="">
                        <option value="">No Selected</option>
                        <?php 
                          foreach ($employeeName as $emp){
                            echo '
                            <option value="'.$emp->p_id.'">'.$emp->p_name.' - '.$emp->p_nip.'</option>
                           ';
                          }
                        ?>
                      </select>
